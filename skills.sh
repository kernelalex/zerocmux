...
Examples:
  ...
  curl -fsSL https://raw.githubusercontent.com/Enigma-Labs-Technology/zerocmux/main/skills.sh | bash
EOF
}
...
if [[ -z "$source_dir" ]]; then
  ...
  archive_url="https://codeload.github.com/Enigma-Labs-Technology/zerocmux/tar.gz/${ref}"
