...
def main() -> int:
    ...
    with cmux(SOCKET_PATH) as client:
        try:
            ...
            _must(
                ...
                f"zerocmux ssh should safely export the remote workspace id into the bootstrap shell: {remote_bootstrap!r}",
            )
            _must(
            ...
            _must(
                ...
                f"zerocmux ssh should safely export the remote surface id into the bootstrap shell: {remote_bootstrap!r}",
            )
            _must(
    ...
    print("PASS: zerocmux ssh preserves initial command text and remote workspace metadata")
    return 0
